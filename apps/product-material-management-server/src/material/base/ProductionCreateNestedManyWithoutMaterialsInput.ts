...
@InputType()
class ProductionCreateNestedManyWithoutMaterialsInput {
...
export { ProductionCreateNestedManyWithoutMaterialsInput as ProductionCreateNestedManyWithoutMaterialsInput };
