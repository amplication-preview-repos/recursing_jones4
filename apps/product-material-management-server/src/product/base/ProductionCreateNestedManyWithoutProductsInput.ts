...
@InputType()
class ProductionCreateNestedManyWithoutProductsInput {
...
export { ProductionCreateNestedManyWithoutProductsInput as ProductionCreateNestedManyWithoutProductsInput };
